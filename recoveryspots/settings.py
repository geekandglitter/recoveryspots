"""
Django settings for recoveryspots project.
...
SECRET_KEY = 'ajj3fy4-_p-rfn58*$4dypq_wrx#zib9+65tgf9pqkqt2&3dvc'
...
INSTALLED_APPS = [
    ...
    'randomizedspots.apps.RandomizedspotsConfig',
    'listofspots.apps.ListofspotsConfig',
    'recoveryspots',
...
ROOT_URLCONF = 'recoveryspots.urls'
...
WSGI_APPLICATION = 'recoveryspots.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'static'),  # Linda added thiszz
)
