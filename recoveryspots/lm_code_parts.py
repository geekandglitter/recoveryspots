...
try:
    req = requests.get(theurl, timeout=(6.0, 6.0))  # This results in JSON
...
try:
    req.raise_for_status()  # will raise an HTTPError if the HTTP request returned an unsuccessful status code
